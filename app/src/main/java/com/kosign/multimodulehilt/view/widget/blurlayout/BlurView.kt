package com.kosign.multimodulehilt.view.widget.blurlayout
...
import com.mobile.bnkcl.util.blurview.BlockingBlurController
import com.mobile.bnkcl.util.blurview.BlockingBlurController.Companion.TRANSPARENT
import com.mobile.bnkcl.util.blurview.BlurController
import com.mobile.bnkcl.util.blurview.BlurViewFacade
import com.mobile.bnkcl.util.blurview.NoOpController
...
//        doBlurRadius()
    ...
    override fun draw(canvas: Canvas?) {
        ...
        for (c in corners) {
            Log.d(">>>>>", "Start drawing BlurView... $c ")
//            if (c != 0f) {
...
//            }
        ...
        blurController.drawRectRound(10f, this.width, this.height, canvas)
//        blurController.draw(canvas)
        super.draw(canvas)
//        if (shouldDraw) {
